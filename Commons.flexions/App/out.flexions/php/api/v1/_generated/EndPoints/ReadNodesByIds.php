...
class  ReadNodesByIdsCallData extends MongoCallDataRawWrapper {
	const ids='ids';
 ...
 class  ReadNodesByIds extends MongoEndPoint {

     function call() {
        /* @var ReadNodesByIdsCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->nodes;
        $ids=$parameters->getValueForKey(ReadNodesByIdsCallData::ids);
        $f=$parameters->getValueForKey(ReadNodesByIdsCallData::result_fields);
        ...
        try {
            ...
            // Sort ?
            $s=$parameters->getCastedDictionaryForKey(ReadNodesByIdsCallData::sort);
