...
class  ReadLockerByIdCallData extends MongoCallDataRawWrapper {
	/* The unique identifier the the of Locker */
	const lockerId='lockerId';
}

 class  ReadLockerById extends MongoEndPoint {

     function call() {
        /* @var ReadLockerByIdCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->lockers;
         $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(ReadLockerByIdCallData::lockerId));
