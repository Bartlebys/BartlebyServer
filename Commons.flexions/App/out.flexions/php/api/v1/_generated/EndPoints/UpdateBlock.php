...
class  UpdateBlockCallData extends MongoCallDataRawWrapper {
	const block='block';
}

 class  UpdateBlock extends MongoEndPoint {

    function call() {
        /* @var UpdateBlockCallData */
        ...
        $obj=$parameters->getValueForKey(UpdateBlockCallData::block);
     ...
     * 
     * @param UpdateBlockCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateBlockCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateBlockCallData::block);
        $homologousAction="ReadBlockById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"blocks","UpdateBlock",$homologousAction,$ref,false);
    }
