...
class  ReadBlocksByIdsCallData extends MongoCallDataRawWrapper {
	const ids='ids';
 ...
 class  ReadBlocksByIds extends MongoEndPoint {

     function call() {
        /* @var ReadBlocksByIdsCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->blocks;
        $ids=$parameters->getValueForKey(ReadBlocksByIdsCallData::ids);
        $f=$parameters->getValueForKey(ReadBlocksByIdsCallData::result_fields);
        ...
        try {
            ...
            // Sort ?
            $s=$parameters->getCastedDictionaryForKey(ReadBlocksByIdsCallData::sort);
