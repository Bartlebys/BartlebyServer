...
class  UpdateNodeCallData extends MongoCallDataRawWrapper {
	const node='node';
}

 class  UpdateNode extends MongoEndPoint {

    function call() {
        /* @var UpdateNodeCallData */
        ...
        $obj=$parameters->getValueForKey(UpdateNodeCallData::node);
     ...
     * 
     * @param UpdateNodeCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateNodeCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateNodeCallData::node);
        $homologousAction="ReadNodeById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"nodes","UpdateNode",$homologousAction,$ref,false);
    }
