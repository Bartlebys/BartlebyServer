...
class  ReadLocalizedDatumByIdCallData extends MongoCallDataRawWrapper {
	/* The unique identifier the the of LocalizedDatum */
	const localizedDatumId='localizedDatumId';
}

 class  ReadLocalizedDatumById extends MongoEndPoint {

     function call() {
        /* @var ReadLocalizedDatumByIdCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->localizedData;
         $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(ReadLocalizedDatumByIdCallData::localizedDatumId));
