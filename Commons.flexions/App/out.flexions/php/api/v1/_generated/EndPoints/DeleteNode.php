...
class  DeleteNodeCallData extends MongoCallDataRawWrapper {
	/* The identifier of the Node to be deleted */
	const nodeId='nodeId';
}

 class  DeleteNode extends MongoEndPoint {

    function call() {
        /* @var DeleteNodeCallData */
        ...
        $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(DeleteNodeCallData::nodeId));
        try {
     ...
     * 
     * @param DeleteNodeCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteNodeCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteNodeCallData::nodeId);
        $homologousAction="DeleteNode";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"nodes","DeleteNode",$homologousAction,$ref,false);
    }
