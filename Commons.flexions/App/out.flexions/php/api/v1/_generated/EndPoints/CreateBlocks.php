...
class  CreateBlocksCallData extends MongoCallDataRawWrapper {
	const blocks='blocks';
}

 class  CreateBlocks extends MongoEndPoint {

    function call() {
        /* @var CreateBlocksCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(CreateBlocksCallData::blocks);
     ...
     * 
     * @param CreateBlocksCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateBlocksCallData $parameters){
        $ref=$parameters->getValueForKey(CreateBlocksCallData::blocks);
        $homologousAction="ReadBlocksById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"blocks","CreateBlocks",$homologousAction,$ref,true);
    }
