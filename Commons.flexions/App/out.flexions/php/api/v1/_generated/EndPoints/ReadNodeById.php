...
class  ReadNodeByIdCallData extends MongoCallDataRawWrapper {
	/* The unique identifier the the of Node */
	const nodeId='nodeId';
}

 class  ReadNodeById extends MongoEndPoint {

     function call() {
        /* @var ReadNodeByIdCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->nodes;
         $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(ReadNodeByIdCallData::nodeId));
