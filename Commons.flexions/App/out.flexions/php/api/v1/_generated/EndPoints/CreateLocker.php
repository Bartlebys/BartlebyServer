...
class  CreateLockerCallData extends MongoCallDataRawWrapper {
	const locker='locker';
}

 class  CreateLocker extends MongoEndPoint {

    function call() {
        /* @var CreateLockerCallData */
        ...
        $obj=$parameters->getValueForKey(CreateLockerCallData::locker);
     ...
     * 
     * @param CreateLockerCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateLockerCallData $parameters){
        $ref=$parameters->getValueForKey(CreateLockerCallData::locker);
        $homologousAction="ReadLockerById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","CreateLocker",$homologousAction,$ref,false);
    }
