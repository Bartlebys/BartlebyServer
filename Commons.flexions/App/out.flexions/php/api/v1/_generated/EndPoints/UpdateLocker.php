...
class  UpdateLockerCallData extends MongoCallDataRawWrapper {
	const locker='locker';
}

 class  UpdateLocker extends MongoEndPoint {

    function call() {
        /* @var UpdateLockerCallData */
        ...
        $obj=$parameters->getValueForKey(UpdateLockerCallData::locker);
     ...
     * 
     * @param UpdateLockerCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateLockerCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateLockerCallData::locker);
        $homologousAction="ReadLockerById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","UpdateLocker",$homologousAction,$ref,false);
    }
