...
class  CreateNodesCallData extends MongoCallDataRawWrapper {
	const nodes='nodes';
}

 class  CreateNodes extends MongoEndPoint {

    function call() {
        /* @var CreateNodesCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(CreateNodesCallData::nodes);
     ...
     * 
     * @param CreateNodesCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateNodesCallData $parameters){
        $ref=$parameters->getValueForKey(CreateNodesCallData::nodes);
        $homologousAction="ReadNodesById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"nodes","CreateNodes",$homologousAction,$ref,true);
    }
