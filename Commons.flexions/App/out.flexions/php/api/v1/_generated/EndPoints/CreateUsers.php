...
class  CreateUsersCallData extends MongoCallDataRawWrapper {
	const users='users';
}

 class  CreateUsers extends MongoEndPoint {

    function call() {
        /* @var CreateUsersCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(CreateUsersCallData::users);
     ...
     * 
     * @param CreateUsersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateUsersCallData $parameters){
        $ref=$parameters->getValueForKey(CreateUsersCallData::users);
        $homologousAction="ReadUsersById";
        $senderUID=NO_UID;
        ...
        return $this->relayTrigger($senderUID,"users","CreateUsers",$homologousAction,$ref,true);
    }
