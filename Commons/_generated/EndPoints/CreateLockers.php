...
class  CreateLockersCallData extends MongoCallDataRawWrapper {
	const lockers='lockers';
}

 class  CreateLockers extends MongoEndPoint {

    function call() {
        /* @var CreateLockersCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(CreateLockersCallData::lockers);
     ...
     * 
     * @param CreateLockersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateLockersCallData $parameters){
        $ref=$parameters->getValueForKey(CreateLockersCallData::lockers);
        $homologousAction="ReadLockersById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","CreateLockers",$homologousAction,$ref,true);
    }
