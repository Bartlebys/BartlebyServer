...
class  ReadLockersByIdsCallData extends MongoCallDataRawWrapper {
	const ids='ids';
 ...
 class  ReadLockersByIds extends MongoEndPoint {

     function call() {
        /* @var ReadLockersByIdsCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->lockers;
        $ids=$parameters->getValueForKey(ReadLockersByIdsCallData::ids);
        $f=$parameters->getValueForKey(ReadLockersByIdsCallData::result_fields);
        ...
        try {
            ...
            // Sort ?
            $s=$parameters->getCastedDictionaryForKey(ReadLockersByIdsCallData::sort);
