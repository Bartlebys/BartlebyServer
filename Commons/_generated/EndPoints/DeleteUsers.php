...
class  DeleteUsersCallData extends MongoCallDataRawWrapper {
	const ids='ids';
}

 class  DeleteUsers extends MongoEndPoint {

    function call() {
        /* @var DeleteUsersCallData */
        ...
        $ids=$parameters->getValueForKey(DeleteUsersCallData::ids);
     ...
     * 
     * @param DeleteUsersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteUsersCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteUsersCallData::ids);
        $homologousAction="DeleteUsers";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"users","DeleteUsers",$homologousAction,$ref,true);
    }
