...
class  ReadUsersByIdsCallData extends MongoCallDataRawWrapper {
	const ids='ids';
 ...
 class  ReadUsersByIds extends MongoEndPoint {

     function call() {
        /* @var ReadUsersByIdsCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->users;
        $ids=$parameters->getValueForKey(ReadUsersByIdsCallData::ids);
        $f=$parameters->getValueForKey(ReadUsersByIdsCallData::result_fields);
        ...
        try {
            ...
            // Sort ?
            $s=$parameters->getCastedDictionaryForKey(ReadUsersByIdsCallData::sort);
