...
class  ReadBoxesByIdsCallData extends MongoCallDataRawWrapper {
	const ids='ids';
 ...
 class  ReadBoxesByIds extends MongoEndPoint {

     function call() {
        /* @var ReadBoxesByIdsCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->boxes;
        $ids=$parameters->getValueForKey(ReadBoxesByIdsCallData::ids);
        $f=$parameters->getValueForKey(ReadBoxesByIdsCallData::result_fields);
        ...
        try {
            ...
            // Sort ?
            $s=$parameters->getCastedDictionaryForKey(ReadBoxesByIdsCallData::sort);
