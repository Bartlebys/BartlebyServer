...
class  DeleteLocalizedDatumCallData extends MongoCallDataRawWrapper {
	/* The identifier of the LocalizedDatum to be deleted */
	const localizedDatumId='localizedDatumId';
}

 class  DeleteLocalizedDatum extends MongoEndPoint {

    function call() {
        /* @var DeleteLocalizedDatumCallData */
        ...
        $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(DeleteLocalizedDatumCallData::localizedDatumId));
        try {
     ...
     * 
     * @param DeleteLocalizedDatumCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteLocalizedDatumCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteLocalizedDatumCallData::localizedDatumId);
        $homologousAction="DeleteLocalizedDatum";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"localizedData","DeleteLocalizedDatum",$homologousAction,$ref,false);
    }
