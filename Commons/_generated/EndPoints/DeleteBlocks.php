...
class  DeleteBlocksCallData extends MongoCallDataRawWrapper {
	const ids='ids';
}

 class  DeleteBlocks extends MongoEndPoint {
     ...
     * 
     * @param DeleteBlocksCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteBlocksCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteBlocksCallData::ids);
        $homologousAction="DeleteBlocks";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"blocks","DeleteBlocks",$homologousAction,$ref,true);
    }
