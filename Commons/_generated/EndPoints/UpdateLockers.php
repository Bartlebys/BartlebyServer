...
class  UpdateLockersCallData extends MongoCallDataRawWrapper {
	const lockers='lockers';
}

 class  UpdateLockers extends MongoEndPoint {

    function call() {
        /* @var UpdateLockersCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(UpdateLockersCallData::lockers);
     ...
     * 
     * @param UpdateLockersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateLockersCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateLockersCallData::lockers);
        $homologousAction="ReadLockersById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","UpdateLockers",$homologousAction,$ref,true);
    }
