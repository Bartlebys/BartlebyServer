...
class  UpdateBoxCallData extends MongoCallDataRawWrapper {
	const box='box';
}

 class  UpdateBox extends MongoEndPoint {

    function call() {
        /* @var UpdateBoxCallData */
        ...
        $obj=$parameters->getValueForKey(UpdateBoxCallData::box);
     ...
     * 
     * @param UpdateBoxCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateBoxCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateBoxCallData::box);
        $homologousAction="ReadBoxById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"boxes","UpdateBox",$homologousAction,$ref,false);
    }
