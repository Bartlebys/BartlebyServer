...
class  CreateBlockCallData extends MongoCallDataRawWrapper {
	const block='block';
}

 class  CreateBlock extends MongoEndPoint {

    function call() {
        /* @var CreateBlockCallData */
        ...
        $obj=$parameters->getValueForKey(CreateBlockCallData::block);
     ...
     * 
     * @param CreateBlockCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateBlockCallData $parameters){
        $ref=$parameters->getValueForKey(CreateBlockCallData::block);
        $homologousAction="ReadBlockById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"blocks","CreateBlock",$homologousAction,$ref,false);
    }
