...
class  DeleteLockersCallData extends MongoCallDataRawWrapper {
	const ids='ids';
}

 class  DeleteLockers extends MongoEndPoint {

    function call() {
        /* @var DeleteLockersCallData */
        ...
        $ids=$parameters->getValueForKey(DeleteLockersCallData::ids);
     ...
     * 
     * @param DeleteLockersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteLockersCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteLockersCallData::ids);
        $homologousAction="DeleteLockers";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","DeleteLockers",$homologousAction,$ref,true);
    }
