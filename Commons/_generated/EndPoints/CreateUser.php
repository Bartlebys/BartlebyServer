...
class  CreateUserCallData extends MongoCallDataRawWrapper {
	const user='user';
}

 class  CreateUser extends MongoEndPoint {

    function call() {
        /* @var CreateUserCallData */
        ...
        $obj=$parameters->getValueForKey(CreateUserCallData::user);
     ...
     * 
     * @param CreateUserCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateUserCallData $parameters){
        $ref=$parameters->getValueForKey(CreateUserCallData::user);
        $homologousAction="ReadUserById";
        $senderUID=KeyPath::valueForKeyPath($parameters->getDictionary(),'user.creatorUID');
        return $this->relayTrigger($senderUID,"users","CreateUser",$homologousAction,$ref,false);
    }
