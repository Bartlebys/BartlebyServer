...
class  UpdateUsersCallData extends MongoCallDataRawWrapper {
	const users='users';
}

 class  UpdateUsers extends MongoEndPoint {

    function call() {
        /* @var UpdateUsersCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(UpdateUsersCallData::users);
     ...
     * 
     * @param UpdateUsersCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateUsersCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateUsersCallData::users);
        $homologousAction="ReadUsersById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"users","UpdateUsers",$homologousAction,$ref,true);
    }
