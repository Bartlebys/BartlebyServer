...
class  DeleteBoxCallData extends MongoCallDataRawWrapper {
	/* The identifier of the Box to be deleted */
	const boxId='boxId';
}

 class  DeleteBox extends MongoEndPoint {

    function call() {
        /* @var DeleteBoxCallData */
        ...
        $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(DeleteBoxCallData::boxId));
        try {
     ...
     * 
     * @param DeleteBoxCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteBoxCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteBoxCallData::boxId);
        $homologousAction="DeleteBox";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"boxes","DeleteBox",$homologousAction,$ref,false);
    }
