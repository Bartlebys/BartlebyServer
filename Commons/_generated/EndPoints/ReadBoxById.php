...
class  ReadBoxByIdCallData extends MongoCallDataRawWrapper {
	/* The unique identifier the the of Box */
	const boxId='boxId';
}

 class  ReadBoxById extends MongoEndPoint {

     function call() {
        /* @var ReadBoxByIdCallData */
        $parameters=$this->getModel();
        $db=$this->getDB();
        /* @var \MongoCollection */
        $collection = $db->boxes;
         $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(ReadBoxByIdCallData::boxId));
