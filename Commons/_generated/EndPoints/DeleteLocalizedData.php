...
class  DeleteLocalizedDataCallData extends MongoCallDataRawWrapper {
	const ids='ids';
}

 class  DeleteLocalizedData extends MongoEndPoint {

    function call() {
        /* @var DeleteLocalizedDataCallData */
        ...
        $ids=$parameters->getValueForKey(DeleteLocalizedDataCallData::ids);
     ...
     * 
     * @param DeleteLocalizedDataCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteLocalizedDataCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteLocalizedDataCallData::ids);
        $homologousAction="DeleteLocalizedData";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"localizedData","DeleteLocalizedData",$homologousAction,$ref,true);
    }
