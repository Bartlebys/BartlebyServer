...
class  CreateBoxCallData extends MongoCallDataRawWrapper {
	const box='box';
}

 class  CreateBox extends MongoEndPoint {

    function call() {
        /* @var CreateBoxCallData */
        ...
        $obj=$parameters->getValueForKey(CreateBoxCallData::box);
     ...
     * 
     * @param CreateBoxCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(CreateBoxCallData $parameters){
        $ref=$parameters->getValueForKey(CreateBoxCallData::box);
        $homologousAction="ReadBoxById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"boxes","CreateBox",$homologousAction,$ref,false);
    }
