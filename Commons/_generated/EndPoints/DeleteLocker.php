...
class  DeleteLockerCallData extends MongoCallDataRawWrapper {
	/* The identifier of the Locker to be deleted */
	const lockerId='lockerId';
}

 class  DeleteLocker extends MongoEndPoint {

    function call() {
        /* @var DeleteLockerCallData */
        ...
        $q = array (MONGO_ID_KEY =>$parameters->getValueForKey(DeleteLockerCallData::lockerId));
        try {
     ...
     * 
     * @param DeleteLockerCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteLockerCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteLockerCallData::lockerId);
        $homologousAction="DeleteLocker";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"lockers","DeleteLocker",$homologousAction,$ref,false);
    }
