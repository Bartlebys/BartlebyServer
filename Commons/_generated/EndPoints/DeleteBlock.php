...
class  DeleteBlockCallData extends MongoCallDataRawWrapper {
	/* The identifier of the Block to be deleted */
	const blockId='blockId';
}

 class  DeleteBlock extends MongoEndPoint {
     ...
     * 
     * @param DeleteBlockCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(DeleteBlockCallData $parameters){
        $ref=$parameters->getValueForKey(DeleteBlockCallData::blockId);
        $homologousAction="DeleteBlock";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"blocks","DeleteBlock",$homologousAction,$ref,false);
    }
