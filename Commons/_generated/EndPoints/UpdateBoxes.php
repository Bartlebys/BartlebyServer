...
class  UpdateBoxesCallData extends MongoCallDataRawWrapper {
	const boxes='boxes';
}

 class  UpdateBoxes extends MongoEndPoint {

    function call() {
        /* @var UpdateBoxesCallData */
        ...
        $arrayOfObject=$parameters->getValueForKey(UpdateBoxesCallData::boxes);
     ...
     * 
     * @param UpdateBoxesCallData $parameters
     ...
     * @throws \Exception
     */
    function createTrigger(UpdateBoxesCallData $parameters){
        $ref=$parameters->getValueForKey(UpdateBoxesCallData::boxes);
        $homologousAction="ReadBoxesById";
        $senderUID=$this->getCurrentUserID($this->getSpaceUID(true));
        return $this->relayTrigger($senderUID,"boxes","UpdateBoxes",$homologousAction,$ref,true);
    }
